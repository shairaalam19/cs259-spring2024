...
def output_file(content, file_path):
...
m0 = testMemrefAdd()
print(m0)
output_file(m0, "MLIR_output/testMemrefAdd.txt")
...
m1 = gpu_frontend(m0)
print(m1)
output_file(m1, "MLIR_output/gpu_frontend.txt")
...
# m2 = gpu_to_llvm(m1)
# print(m2)
# output_file(m2, "MLIR_output/gpu_to_llvm.txt")
